...
**Tópicos principais:**
- Redução da dependência estratégica dos EUA (defesa, tecnologia, diplomacia) com diversificação de fornecedores, cloud soberana e voto na ONU por interesse nacional
...
**Tópicos principais:**
- Domínio de informação marítima: arquitetura nacional em camadas com satélite, sensores costeiros, drones ISR, navios e AUV/ROV, integrados num Lago de Dados Marítimos com separação de camadas públicas, operacionais e classificadas
- Capacidade de interceção e resposta: dissuasão por prevenção com camadas aérea, marítima, terrestre e cibernética, com eixo Sul (Alentejo/Algarve) como hub de defesa, treino e logística
- Proteção de infraestruturas críticas: cabos submarinos, portos e energia offshore com planos de continuidade, redundância e exercícios anuais
- Deep-sea tech como valor económico: robótica submarina, mapeamento, sensores, dados, biotecnologia marinha e Gémeo Digital do Atlântico português
- Moratória 2050 com exceções apenas para investigação científica, com licenciamento público, comissão independente e cláusula de reversibilidade
...
**Tópicos principais:**
- Urban Mining: recuperação avançada de metais críticos de resíduos eletrónicos e baterias, com Portugal como hub europeu de reciclagem limpa; enfrenta desafios de hábitos de retenção doméstica e baixa recolha per capita face à média UE
- Biotecnologia marinha: exploração de organismos oceânicos para aplicações farmacêuticas, industriais e de defesa; capitalizar capacidade científica existente com financiamento faseado por marcos (stage-gate)
- Deep-Sea Tech: robótica submarina, mapeamento, sensores e dados oceânicos como multiplicador de soberania e indústria exportadora
- Comparação estratégica: Urban Mining (retorno curto-médio, risco ambiental baixo), Biotecnologia (médio-longo, baixo), Deep-Sea Tech (médio, baixo) vs Mineração mar profundo (longo, elevado, baixa aceitação)
- Roteiro: Fase 1 (0-4 anos) Urban Mining, Fase 2 (2-6 anos) Deep-Sea Tech, Fase 3 (5-10 anos) Biotecnologia; mineração comercial reavaliada apenas após 2050
...
**Tópicos principais:**
- Sistema SNIDV: verificação de identidade obrigatória (Face ID, Chave Móvel Digital, Cartão de Cidadão NFC) para criar contas em plataformas com >1M utilizadores em Portugal
- Base de Dados Nacional de Banimentos Digitais: registo centralizado de banimentos decretados por tribunais, comunicação automática a plataformas via API, bloqueio de novas contas por banidos
- Responsabilização das plataformas: regime de responsabilidade civil solidária por danos causados por utilizadores não verificados; multas até 6% da faturação global por incumprimento
- Banimento judicial como pena acessória: para crimes digitais (burla, phishing, cyberstalking, crimes sexuais) com durações de 1 a 10 anos ou perpétuo para crimes contra menores
- Proteção de dados: minimização de dados (apenas confirmação sim/não), dados biométricos eliminados após verificação, hash anónimo na base de banimentos, exceções para jornalistas/denunciantes, supervisão pela CNPD
